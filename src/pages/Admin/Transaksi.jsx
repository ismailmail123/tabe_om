...
import { CheckCircle, Upload } from "lucide-react" // ✅ import icon
  ...
  return (
    <div className="p-8">
      ...
      <main className="flex-1 p-8">
        <h1 className="text-2xl font-bold mb-6">Daftar Transaksi Pengguna</h1>
            ...
            <table className="min-w-full border-collapse">
              <thead className="bg-blue-700 text-white">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left">Nomor Register</th>
