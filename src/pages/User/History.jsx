  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center mb-4">
        <ShoppingBag className="w-9 h-9 text-blue-300" />
      </div>
      <p className="font-semibold text-gray-700 text-base mb-1">Belum ada transaksi</p>
    ...
    <div className={`bg-white rounded-2xl border transition-all duration-200 overflow-hidden
      ...
      {expanded && (
        <div className="border-t border-gray-50 px-4 pb-4 pt-3 space-y-3">
          ...
          {order.purchase_receipt_photo && (
            <div>
              <p className="text-xs font-medium text-gray-500 mb-1.5 flex items-center gap-1">
                <ImageIcon size={12} /> Bukti Pengambilan
              </p>
              <img
                src={order.purchase_receipt_photo}
                alt="Bukti Pengambilan"
                className="w-full max-w-[200px] rounded-xl border object-cover"
              />
            </div>
          )}
          ...
          <button
            onClick={onDetail}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-xl text-xs font-semibold
              flex items-center justify-center gap-1.5 transition-colors"
          >
            Detail Lengkap <ArrowRight size={13} />
          </button>
        </div>
      )}
    </div>
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
      <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-xl overflow-hidden animate-slideUp max-h-[92vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <div>
            <h3 className="font-bold text-gray-900 text-base">Detail Transaksi</h3>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-5 py-4 space-y-5">
            ...
            <div className="flex gap-2 flex-wrap">
              <div className="flex-1 bg-gray-50 rounded-xl p-3 min-w-[140px]">
                <p className="text-xs text-gray-400 mb-1.5">Status Order</p>
        ...
        <div className="px-5 py-4 border-t border-gray-100 bg-white">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-lg font-bold text-emerald-600">{formatRupiah(selected.total)}</span>
          </div>
          {needsPayment ? (
            <button
              onClick={onPayment}
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-end sm:items-center justify-center z-[60] p-0 sm:p-4">
      <div className="bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-xl overflow-hidden animate-slideUp">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h3 className="font-bold text-gray-900 text-base">Pilih Pembayaran</h3>
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors"
          >
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div className="bg-blue-50 rounded-xl px-4 py-3 flex justify-between items-center">
            <div>
              <p className="text-xs text-blue-600 font-medium">Order #{selected.id}</p>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-1">
                <p className={`font-semibold text-sm ${method === "transfer" ? "text-blue-800" : "text-gray-700"}`}>
                  Transfer Bank
                </p>
      ...
      <div className="min-h-screen bg-gray-50 font-['Inter',_'Poppins',_sans-serif]">
        ...
        <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900 leading-tight">Riwayat Belanja</h1>
                  ...
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      {["Tanggal", "Nama WBP", "Total", "Status Order", "Pembayaran", ""].map(h => (
                        <th key={h} className={`py-3 px-4 text-xs font-semibold text-gray-500 ${h === "" ? "text-center" : "text-left"}`}>
                          {h}
                        </th>
                      ))}
                    </tr>
