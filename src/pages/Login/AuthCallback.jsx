...
//       // Cek token dari hash parameters (paling reliable)
//       if (window.location.hash) {
//         const hashParams = new URLSearchParams(window.location.hash.substring(1));
//         token = hashParams.get('token');
//       }

//       // Cek token dari query parameters
//       if (!token && window.location.search) {
//         const urlParams = new URLSearchParams(window.location.search);
//         token = urlParams.get('token');
//       }

//       // Cek token dari React Router location
//       if (!token && location.search) {
//         const routerParams = new URLSearchParams(location.search);
//         token = routerParams.get('token');
//       }

//       if (token) {
//         try {
//           // Decode token jika perlu
...
//         }
//       } else {
//         // Jika tidak ada token, redirect ke login dengan error
